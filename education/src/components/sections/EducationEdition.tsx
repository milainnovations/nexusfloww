...
export function EducationEdition() {
  return (
    <section id="education" className="py-20 lg:py-28 bg-[#f4f8f5]/50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <SectionHeader
            badge="Education Edition"
            title="Education CRM & ERP Operating System"
            subtitle="Digitize your institution from admissions to graduation with specialized education workflows."
          />
        </FadeIn>

        <FadeIn delay={0.1}>
          <h3 className="mb-6 text-xl font-bold text-[#14241e]">
            Admissions & Student CRM
          </h3>
        </FadeIn>
