            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <div className="rounded-xl border border-[#edf3ef] bg-[#fafcfb] p-4">
                  ...
                  <div className="mt-2 h-2 w-full overflow-hidden rounded-full bg-[#e5ebe7]">
                    <div className="h-full bg-[#0e4b38] rounded-full" style={{ width: '88%' }} />
                  </div>
                  <div className="text-[10px] text-[#82968e] mt-1">Teacher: Prof. Vikram Singh</div>
                </div>
                ...
                <div className="rounded-xl border border-[#edf3ef] bg-[#fafcfb] p-4">
                  ...
                  <div className="text-[10px] text-[#82968e] mt-1">Teacher: Dr. Priya Patel</div>
                </div>
                ...
                <div className="rounded-xl border border-[#edf3ef] bg-[#fafcfb] p-4">
                  ...
                  <div className="text-[10px] text-[#82968e] mt-1">Teacher: Mrs. Sunita Rao</div>
                </div>
                ...
                <div className="rounded-xl border border-[#edf3ef] bg-[#fafcfb] p-4">
                  ...
                  <div className="text-[10px] text-[#82968e] mt-1">Teacher: Mr. Arjun Verma</div>
                </div>
              </div>
